...
public class kota {
    ...
    private static final Location[] DUMMY_KOTA = new Location[]{
            ...
            k("Aethelgard", "Pusat kerajaan dengan istana megah dan perpustakaan luas penuh pengetahuan tentang pertanian dan nutrisi. Para ahli kerajaan bekerja keras mengembangkan benih unggul untuk mengatasi kekurangan pangan global."),
